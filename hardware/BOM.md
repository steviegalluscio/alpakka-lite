...
| LSM6DS3 breakout              | IMU sensor          | 2x        | $9 (Total)  | 2pcs for $9 with overnight delivery (LSM6DSV is better but less available) |
...
| ~7" 22-24 AWG stranded wire   | Wiring              | 14x       | ~$1 (Total) | Buy rainbow cable or cut cheap breadboard jumpers                          |
| 3D print rumble_mount         | Left IMU mount      | 1         |  ~$0        | Easy print, ask a friend or use hot glue and wing it                       |
| 3D print rumble_mount (mirror)| Right IMU mount     | 1         |  ~$0        | Mirror it in slicer or CAD                                                 |
